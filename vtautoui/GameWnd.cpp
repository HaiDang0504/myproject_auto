...
DWORD GameWnd::GetCharBaseAddress()
{
	...
	ReadProcessMemory(this->handle, (LPCVOID)(uintptr_t)NPC_BASE, (LPVOID)&npcBaseAddress, 4, NULL);

	DWORD playerIndexBaseAddress;
	ReadProcessMemory(this->handle, (LPCVOID)(uintptr_t)PLAYER_INDEX_BASE, (LPVOID)&playerIndexBaseAddress, 4, NULL);
